    ...
    <footer className="bg-white">
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        <nav className="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
          ...
          <div className="px-5 py-2">
            <Link href="/services">
              <a className="text-base text-gray-500 hover:text-gray-900">Services</a>
            </Link>
          </div>
          <div className="px-5 py-2">
            <Link href="/pricing">
          ...
          <div className="px-5 py-2">
            <Link href="/resources">
              <a className="text-base text-gray-500 hover:text-gray-900">Resources</a>
            </Link>
          </div>
          <div className="px-5 py-2">
            <Link href="/blog">
        ...
        <p className="mt-8 text-center text-base text-gray-400">
          &copy; 2023 Trademarkia, Inc. All rights reserved.
        </p>
      </div>
    </footer>
  );
